...
export default function About() {
    return (
        <Section id='about' isHscreen={false} className='lg:px-20 bg-gradient-to-b from-transparent via-transparent to-white lg:h-screen px-5 flex flex-col items-center lg:flex-row lg:gap-10 mt-14 md:mt-28 lg:mt-0'>
